...
type UploadStatus = 'idle' | 'uploading' | 'splitting' | 'processing' | 'fetching' | 'complete' | 'error'
    ...
    return (
        <div
            ...
            className={cn(
                ...
                isDragging ? 'border-primary bg-primary/10 scale-[1.02]' : 'border-muted-foreground/30 bg-card hover:border-primary/50 hover:bg-muted/50',
