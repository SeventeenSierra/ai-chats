...
import { splitImportedFile, processConversations, getImportJobStatus } from '@ai-chat/ai'
import { type NextRequest, NextResponse } from 'next/server'

// Helper to wait for a job to complete
async function waitForJobCompletion(jobId: string, maxWaitMs = 60000, pollIntervalMs = 1000): Promise<boolean> {
